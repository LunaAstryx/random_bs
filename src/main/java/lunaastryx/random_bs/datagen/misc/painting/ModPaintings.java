...
public class ModPaintings {
    ...
    public static final ResourceKey<PaintingVariant> VICTORY_KEY = create("victory");


    public static void bootstrap(BootstrapContext<PaintingVariant> context) {
        register(context, VICTORY_KEY, 4, 3, true);
    }


    private static ResourceKey<PaintingVariant> create(final String id) {
        return ResourceKey.create(Registries.PAINTING_VARIANT, Identifier.fromNamespaceAndPath(RandomBS.MOD_ID, id));
    }
