...
public class RandomBSEnglishLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider provider, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("trim_pattern.random_bs.puffer", "Puffer Armor Trim");
        ...
        translationBuilder.add("sound.random_bs.yummy", "Baguette Hit");
        ...
        translationBuilder.add("entity.minecraft.villager.random_bs.guy", "Guy");
        translationBuilder.add("entity.minecraft.villager.random_bs.florist", "Florist Guy");
